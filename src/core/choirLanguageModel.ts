...
const KEYWORD_HOVER: Record<string, string> = {
  ...
  import: "Resolve and attach a deterministic library selector into workspace scope.",
  ...
  install: "Install a library selector and materialize capabilities under .choir/libraries.",
  update: "Update a locked library to latest available local version.",
  lock: "Validate and normalize choir.lock deterministically.",
