...
import { deriveStrategicSummary } from "./strategicSummaryViewModel.js";
import type {
  AuditView,
  Dashboard,
  DiffView,
...
export class ChoirProductService {
  ...
  async buildSnapshot(
    ...
    const strategicSummary = deriveStrategicSummary(controlPlaneToChoirConfig(control), orchestrationTrace);
